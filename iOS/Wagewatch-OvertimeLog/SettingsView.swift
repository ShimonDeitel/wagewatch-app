...
struct SettingsView: View {
    ...
    var body: some View {
        Form {
            ...
            Section("Wagewatch - Overtime Log Pro") {
                if purchases.isPro {
            ...
            Section("About") {
                Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/wagewatch-app/privacy.html")!)
                Link("Terms of Use", destination: URL(string: "https://shimondeitel.github.io/wagewatch-app/terms.html")!)
                Text("Version 1.0")
